...
fun main(args: Array<String>) {
    ...
    val inspection = InspectionOuterClass.ListInspectionsRequest.newBuilder()
            ...
            .addInspectionIds(internalId("5wuR1Lb-A-8s")) // #1 change to your inspection id
            .build()
...
private fun internalId(inspectionId: String): IntegrationId.IntegrationID = IntegrationId.IntegrationID.newBuilder().setId(inspectionId).build()
